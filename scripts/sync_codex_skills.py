...
Lattice Brain is an offline-first low-RAM chat and coding brain with five hard rules:
...
SOURCE_SKILLS = [
    SkillSpec(
        name="lattice-brain-build-orchestrator",
        display_name="LB Orchestrator",
        short_description="Drive repo work in algorithmic-brain order.",
        default_prompt="Use $lattice-brain-build-orchestrator to implement the next offline Lattice Brain subsystem without placeholders.",
        description="Coordinate repo-wide work for Lattice Brain's offline-first algorithmic brain plan. Use when Codex needs subsystem order, cross-cutting guardrails, or the repo-specific execution map for real runtime changes.",
...
""",
    ...
    SkillSpec(
        name="lattice-brain-shared-types",
        display_name="LB Shared Types",
        short_description="Maintain dialogue and evidence contracts.",
        default_prompt="Use $lattice-brain-shared-types to update `brain/types.py` and related contracts.",
        description="Build or revise the shared Lattice Brain contracts. Use when Codex is working on IDs, response plans, dialogue state, evidence types, provenance, or cross-subsystem payload shapes in this repo.",
        source_markdown=ROOT / "skills" / "component-01-shared-types.md",
        body=_component_body("Maintain Shared Contracts"),
    ),
    SkillSpec(
        name="lattice-brain-input-normalizer",
        display_name="LB Input Normalizer",
        short_description="Normalize text, file, and voice input.",
        default_prompt="Use $lattice-brain-input-normalizer to update input adapters and normalized signal handling in this repo.",
        description="Implement or refine Lattice Brain input normalization. Use when Codex needs to convert text, documents, or voice input into the repo's canonical `NormalizedSignal` contract.",
        source_markdown=ROOT / "skills" / "component-02-input-normalizer.md",
        body=_component_body("Maintain Input Normalization"),
    ),
    SkillSpec(
        name="lattice-brain-dialogue-state",
        display_name="LB Dialogue",
        short_description="Maintain compact dialogue and tone state.",
        default_prompt="Use $lattice-brain-dialogue-state to work on dialogue-state inference and tone fusion in this repo.",
        description="Implement or refine the Lattice Brain dialogue-state layer. Use when Codex is updating tone, urgency, clarification signals, or compact session-state logic that influences planning and response behavior.",
        source_markdown=ROOT / "skills" / "component-03-dialogue-state.md",
        body=_component_body("Maintain Dialogue State"),
    ),
    SkillSpec(
        name="lattice-brain-memory-graph",
        display_name="LB Memory",
        short_description="Work on SQLite plus HNSW grounded memory.",
        default_prompt="Use $lattice-brain-memory-graph to update the hardened memory stack in this repo.",
        description="Implement or refine the Lattice Brain memory subsystem. Use when Codex is working on SQLite metadata, HNSW vector recall, session edges, workspace facts, provenance, or grounded memory ranking.",
        source_markdown=ROOT / "skills" / "component-04-memory-graph.md",
        body=_component_body("Maintain Memory Graph"),
    ),
    SkillSpec(
        name="lattice-brain-reasoning-modules",
        display_name="LB Reasoning",
        short_description="Maintain bounded reasoning modules.",
        default_prompt="Use $lattice-brain-reasoning-modules to work on planning, retrieval-backed reasoning, and synthesis in this repo.",
        description="Implement or refine the Lattice Brain reasoning layer. Use when Codex is working on bounded reasoning modules, workspace retrieval, patch planning, contradiction checks, or grounded response assembly.",
        source_markdown=ROOT / "skills" / "component-05-reasoning-modules.md",
        body=_component_body("Maintain Reasoning Modules"),
    ),
    SkillSpec(
        name="lattice-brain-learning-pipeline",
        display_name="LB Learning",
        short_description="Maintain offline learning artifacts.",
        default_prompt="Use $lattice-brain-learning-pipeline to work on offline training, feedback scoring, and artifact generation in this repo.",
        description="Implement or refine the Lattice Brain learning pipeline. Use when Codex is working on offline dataset preparation, feedback scoring, artifact training, trace collection, or reproducible export for compact runtime components.",
        source_markdown=ROOT / "skills" / "component-06-learning-pipeline.md",
        body=_component_body("Maintain Learning Pipeline"),
    ),
    SkillSpec(
        name="lattice-brain-decision-engine",
        display_name="LB Decision",
        short_description="Maintain fast intent and policy selection.",
        default_prompt="Use $lattice-brain-decision-engine to work on routing, policy artifacts, or the optional Rust daemon in this repo.",
        description="Implement or refine the Lattice Brain decision engine. Use when Codex is updating policy labels, routing artifacts, Rust inference, gRPC routing, or action-selection behavior.",
        source_markdown=ROOT / "skills" / "component-07-decision-engine.md",
        body=_component_body("Maintain Decision Engine"),
    ),
    SkillSpec(
        name="lattice-brain-interface-bridge",
        display_name="LB Interface",
        short_description="Maintain Fastify and Python bridge serving.",
        default_prompt="Use $lattice-brain-interface-bridge to update the Fastify surface or Python bridge for this repo.",
        description="Implement or refine the Lattice Brain serving surface. Use when Codex is working on Fastify routes, WebSocket streaming, concurrent Python bridge behavior, or multimodal request contracts for the offline brain.",
        source_markdown=ROOT / "skills" / "component-08-interface-bridge.md",
        body=_component_body("Maintain Interface And Bridge"),
    ),
    SkillSpec(
        name="lattice-brain-quality-gates",
        display_name="LB Quality Gates",
        short_description="Maintain CI, guards, and skill validation.",
        default_prompt="Use $lattice-brain-quality-gates to update quality gates, requirements splits, or skill validation in this repo.",
        description="Implement or refine the Lattice Brain quality gates. Use when Codex is working on dependency grouping, placeholder guards, skill sync/validation, offline-first rules, or anti-regression checks for this repo.",
