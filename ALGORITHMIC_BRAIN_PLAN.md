# Lattice Brain Algorithmic Brain Plan
...
Build Lattice Brain into an offline-first chat and coding system that stays useful without depending on a dense local LLM or request-time internet access.
...
Without a dense generative model, Lattice Brain will not match frontier LLMs on unconstrained creativity or open-world knowledge.
