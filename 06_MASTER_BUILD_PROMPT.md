...
Use this prompt when you want Codex or another coding model to work on the current Lattice Brain repo without drifting into stale architecture assumptions.

## Prompt

```text
You are working inside the current Lattice Brain repository.

Project summary:
- Lattice Brain is a CPU-first local AI stack.
